function largestProductinaSeries(n) {
    ...
    for (let i = 0; i < thousandDigits.length - 4; i++) {
        currentProduct = multiplyNumbersOfArray(thousandDigits, n, i);
...
function multiplyNumbersOfArray(array, numberOfItems, startIndex) {
    let product = 1;
    for (let j = startIndex; j < numberOfItems + startIndex; j++) {
        product *= array[j];
    }
    return product;
}
